...
#let ex = exercice(
  ...
  contenu: (
    [On fixe un entier $n >= 1$. Une structure Union-Find maintient une partition
      de $E = {0, dots, n-1}$, initialement formée de singletons, et fournit
      ...
      Les arguments sont des éléments quelconques de $E$, pas nécessairement
    ...
    question([
      ...
      non orienté de sommets $E$, initialement sans arêtes, stocké dans une
      matrice d’adjacence booléenne $A$.

      L’opération `union(x, y)` affecte la valeur vraie aux cases $A[x,y]$ et
      $A[y,x]$, en temps $O(1)$. Ajouter cette arête fusionne exactement les
    ...
    question([
      ...
      sont sans arêtes, sur les $n$ sommets de $E$.
